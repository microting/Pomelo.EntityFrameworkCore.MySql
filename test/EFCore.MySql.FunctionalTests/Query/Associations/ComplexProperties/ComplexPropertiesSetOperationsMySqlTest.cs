...
public class ComplexPropertiesSetOperationsMySqlTest : ComplexPropertiesSetOperationsTestBase<ComplexPropertiesSetOperationsMySqlTest.ComplexPropertiesSetOperationsMySqlTestFixture>
{
    public ComplexPropertiesSetOperationsMySqlTest(ComplexPropertiesSetOperationsMySqlTestFixture fixture)
        : base(fixture)
    {
    }

    public class ComplexPropertiesSetOperationsMySqlTestFixture : ComplexPropertiesFixtureBase
    {
