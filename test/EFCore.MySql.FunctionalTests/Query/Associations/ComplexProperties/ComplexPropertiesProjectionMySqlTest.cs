...
public class ComplexPropertiesProjectionMySqlTest : ComplexPropertiesProjectionTestBase<ComplexPropertiesProjectionMySqlTest.ComplexPropertiesProjectionMySqlTestFixture>
{
    public ComplexPropertiesProjectionMySqlTest(ComplexPropertiesProjectionMySqlTestFixture fixture)
        : base(fixture)
    {
    }

    public class ComplexPropertiesProjectionMySqlTestFixture : ComplexPropertiesFixtureBase
    {
