...
public class ComplexPropertiesCollectionMySqlTest : ComplexPropertiesCollectionTestBase<ComplexPropertiesCollectionMySqlTest.ComplexPropertiesCollectionMySqlTestFixture>
{
    public ComplexPropertiesCollectionMySqlTest(ComplexPropertiesCollectionMySqlTestFixture fixture)
        : base(fixture)
    {
    }

    public class ComplexPropertiesCollectionMySqlTestFixture : ComplexPropertiesFixtureBase
    {
