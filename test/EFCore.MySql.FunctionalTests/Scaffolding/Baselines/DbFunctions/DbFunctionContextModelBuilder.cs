    ...
    public partial class DbFunctionContextModel
    {
        ...
        partial void Initialize()
        {
            ...
            var condition = getCount.AddParameter(
                ...
                false,
                "char(256)");
            condition.TypeMapping = MySqlStringTypeMapping.Default.Clone(
            ...
            getCount.TypeMapping = MySqlIntTypeMapping.Default.Clone(
            ...
            var id0 = getData0.AddParameter(
                ...
                false,
                "int");
            id0.TypeMapping = MySqlIntTypeMapping.Default.Clone(
                comparer: new ValueComparer<int>(
                    bool (int v1, int v2) => v1 == v2,
                    int (int v) => v,
                    int (int v) => v),
            ...
            var date = isDateStatic.AddParameter(
                ...
                false,
                "char(256)");
            date.TypeMapping = MySqlStringTypeMapping.Default.Clone(
                comparer: new ValueComparer<string>(
                    bool (string v1, string v2) => v1 == v2,
                    int (string v) => ((object)v).GetHashCode(),
                    string (string v) => v),
            ...
            isDateStatic.TypeMapping = MySqlBoolTypeMapping.Default.Clone(
        ...
        private IRelationalModel CreateRelationalModel()
        {
            ...
            var blobFunctionColumn = new FunctionColumn("Blob", "longblob", getAllDataFunction)
            {
                IsNullable = true
            };
            ...
            var blobFunctionColumn0 = new FunctionColumn("Blob", "longblob", getDataFunction)
            {
                IsNullable = true
            };
            getDataFunction.Columns.Add("Blob", blobFunctionColumn0);
            relationalModel.Functions.Add(
                ("GetData", null, new[] { "int" }),
                getDataFunction);
            ...
            relationalModel.Functions.Add(
                ("CustomerOrderCount", "dbf", new[] { "char(36)", "char(256)" }),
