...
public partial class DbContextModel
{
    ...
    private IRelationalModel CreateRelationalModel()
    {
        ...
        var dataColumnBase = new ColumnBase<ColumnMappingBase>("Data", "longtext", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentDerivedintTableBase)
        {
            IsNullable = true
        };
        ...
        var dataColumn = new Column("Data", "longtext", dependentDerivedintTable)
        {
            IsNullable = true
        };
