...
public partial class DbContextModel
{
    ...
    private IRelationalModel CreateRelationalModel()
    {
        ...
        var idColumnBase = new ColumnBase<ColumnMappingBase>("Id", "tinyint unsigned", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteTableBase);
        ...
        var idColumn = new Column("Id", "tinyint unsigned", dependentBasebyteTable);
        ...
        var arrayJsonArray = new RelationalJsonArray(refTypeArrayColumnBase, true);
        var scalarJsonScalar = new RelationalJsonScalar(arrayJsonArray, false);
        arrayJsonArray.ElementType = scalarJsonScalar;
        refTypeArrayColumnBase.JsonElement = arrayJsonArray;
        var arrayJsonArray0 = new RelationalJsonArray(refTypeEnumerableColumnBase, true);
        var scalarJsonScalar0 = new RelationalJsonScalar(arrayJsonArray0, false);
        arrayJsonArray0.ElementType = scalarJsonScalar0;
        refTypeEnumerableColumnBase.JsonElement = arrayJsonArray0;
        var arrayJsonArray1 = new RelationalJsonArray(refTypeIListColumnBase, true);
        var scalarJsonScalar1 = new RelationalJsonScalar(arrayJsonArray1, false);
        arrayJsonArray1.ElementType = scalarJsonScalar1;
        refTypeIListColumnBase.JsonElement = arrayJsonArray1;
        var arrayJsonArray2 = new RelationalJsonArray(refTypeListColumnBase, true);
        var scalarJsonScalar2 = new RelationalJsonScalar(arrayJsonArray2, false);
        arrayJsonArray2.ElementType = scalarJsonScalar2;
        refTypeListColumnBase.JsonElement = arrayJsonArray2;
        var arrayJsonArray3 = new RelationalJsonArray(valueTypeArrayColumnBase, true);
        var scalarJsonScalar3 = new RelationalJsonScalar(arrayJsonArray3, false);
        arrayJsonArray3.ElementType = scalarJsonScalar3;
        valueTypeArrayColumnBase.JsonElement = arrayJsonArray3;
        var arrayJsonArray4 = new RelationalJsonArray(valueTypeEnumerableColumnBase, true);
        var scalarJsonScalar4 = new RelationalJsonScalar(arrayJsonArray4, false);
        arrayJsonArray4.ElementType = scalarJsonScalar4;
        valueTypeEnumerableColumnBase.JsonElement = arrayJsonArray4;
        var arrayJsonArray5 = new RelationalJsonArray(valueTypeIListColumnBase, true);
        var scalarJsonScalar5 = new RelationalJsonScalar(arrayJsonArray5, false);
        arrayJsonArray5.ElementType = scalarJsonScalar5;
        valueTypeIListColumnBase.JsonElement = arrayJsonArray5;
        var arrayJsonArray6 = new RelationalJsonArray(valueTypeListColumnBase, true);
        var scalarJsonScalar6 = new RelationalJsonScalar(arrayJsonArray6, false);
        arrayJsonArray6.ElementType = scalarJsonScalar6;
        valueTypeListColumnBase.JsonElement = arrayJsonArray6;
        ...
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeArray")!, arrayJsonArray, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeEnumerable")!, arrayJsonArray0, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeIList")!, arrayJsonArray1, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeList")!, arrayJsonArray2, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeArray")!, arrayJsonArray3, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeEnumerable")!, arrayJsonArray4, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeIList")!, arrayJsonArray5, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeList")!, arrayJsonArray6, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase);
        ...
        var arrayJsonArray7 = new RelationalJsonArray(refTypeArrayColumn, true);
        var scalarJsonScalar7 = new RelationalJsonScalar(arrayJsonArray7, false);
        arrayJsonArray7.ElementType = scalarJsonScalar7;
        refTypeArrayColumn.JsonElement = arrayJsonArray7;
        var arrayJsonArray8 = new RelationalJsonArray(refTypeEnumerableColumn, true);
        var scalarJsonScalar8 = new RelationalJsonScalar(arrayJsonArray8, false);
        arrayJsonArray8.ElementType = scalarJsonScalar8;
        refTypeEnumerableColumn.JsonElement = arrayJsonArray8;
        var arrayJsonArray9 = new RelationalJsonArray(refTypeIListColumn, true);
        var scalarJsonScalar9 = new RelationalJsonScalar(arrayJsonArray9, false);
        arrayJsonArray9.ElementType = scalarJsonScalar9;
        refTypeIListColumn.JsonElement = arrayJsonArray9;
        var arrayJsonArray10 = new RelationalJsonArray(refTypeListColumn, true);
        var scalarJsonScalar10 = new RelationalJsonScalar(arrayJsonArray10, false);
        arrayJsonArray10.ElementType = scalarJsonScalar10;
        refTypeListColumn.JsonElement = arrayJsonArray10;
        var arrayJsonArray11 = new RelationalJsonArray(valueTypeArrayColumn, true);
        var scalarJsonScalar11 = new RelationalJsonScalar(arrayJsonArray11, false);
        arrayJsonArray11.ElementType = scalarJsonScalar11;
        valueTypeArrayColumn.JsonElement = arrayJsonArray11;
        var arrayJsonArray12 = new RelationalJsonArray(valueTypeEnumerableColumn, true);
        var scalarJsonScalar12 = new RelationalJsonScalar(arrayJsonArray12, false);
        arrayJsonArray12.ElementType = scalarJsonScalar12;
        valueTypeEnumerableColumn.JsonElement = arrayJsonArray12;
        var arrayJsonArray13 = new RelationalJsonArray(valueTypeIListColumn, true);
        var scalarJsonScalar13 = new RelationalJsonScalar(arrayJsonArray13, false);
        arrayJsonArray13.ElementType = scalarJsonScalar13;
        valueTypeIListColumn.JsonElement = arrayJsonArray13;
        var arrayJsonArray14 = new RelationalJsonArray(valueTypeListColumn, true);
        var scalarJsonScalar14 = new RelationalJsonScalar(arrayJsonArray14, false);
        arrayJsonArray14.ElementType = scalarJsonScalar14;
        valueTypeListColumn.JsonElement = arrayJsonArray14;
        ...
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeArray")!, arrayJsonArray7, principalBaseTableMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeEnumerable")!, arrayJsonArray8, principalBaseTableMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeIList")!, arrayJsonArray9, principalBaseTableMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeList")!, arrayJsonArray10, principalBaseTableMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeArray")!, arrayJsonArray11, principalBaseTableMapping);
        ...
        var refTypeArrayViewColumn = new ViewColumn("RefTypeArray", "longtext", principalBaseViewView)
        {
            IsNullable = true
        };
        principalBaseViewView.Columns.Add("RefTypeArray", refTypeArrayViewColumn);
        var refTypeEnumerableViewColumn = new ViewColumn("RefTypeEnumerable", "longtext", principalBaseViewView)
        {
            IsNullable = true
        };
        principalBaseViewView.Columns.Add("RefTypeEnumerable", refTypeEnumerableViewColumn);
        var refTypeIListViewColumn = new ViewColumn("RefTypeIList", "longtext", principalBaseViewView)
        {
            IsNullable = true
        };
        principalBaseViewView.Columns.Add("RefTypeIList", refTypeIListViewColumn);
        var refTypeListViewColumn = new ViewColumn("RefTypeList", "longtext", principalBaseViewView)
        {
            IsNullable = true
        };
        principalBaseViewView.Columns.Add("RefTypeList", refTypeListViewColumn);
        var valueTypeArrayViewColumn = new ViewColumn("ValueTypeArray", "longtext", principalBaseViewView)
        {
            IsNullable = true
        };
        principalBaseViewView.Columns.Add("ValueTypeArray", valueTypeArrayViewColumn);
        var valueTypeEnumerableViewColumn = new ViewColumn("ValueTypeEnumerable", "longtext", principalBaseViewView)
        {
            IsNullable = true
        };
        principalBaseViewView.Columns.Add("ValueTypeEnumerable", valueTypeEnumerableViewColumn);
        var valueTypeIListViewColumn = new ViewColumn("ValueTypeIList", "longtext", principalBaseViewView)
        {
            IsNullable = true
        };
        principalBaseViewView.Columns.Add("ValueTypeIList", valueTypeIListViewColumn);
        var valueTypeListViewColumn = new ViewColumn("ValueTypeList", "longtext", principalBaseViewView)
        {
            IsNullable = true
        };
        principalBaseViewView.Columns.Add("ValueTypeList", valueTypeListViewColumn);
        var arrayJsonArray15 = new RelationalJsonArray(refTypeArrayViewColumn, true);
        var scalarJsonScalar15 = new RelationalJsonScalar(arrayJsonArray15, false);
        arrayJsonArray15.ElementType = scalarJsonScalar15;
        refTypeArrayViewColumn.JsonElement = arrayJsonArray15;
        var arrayJsonArray16 = new RelationalJsonArray(refTypeEnumerableViewColumn, true);
        var scalarJsonScalar16 = new RelationalJsonScalar(arrayJsonArray16, false);
        arrayJsonArray16.ElementType = scalarJsonScalar16;
        refTypeEnumerableViewColumn.JsonElement = arrayJsonArray16;
        var arrayJsonArray17 = new RelationalJsonArray(refTypeIListViewColumn, true);
        var scalarJsonScalar17 = new RelationalJsonScalar(arrayJsonArray17, false);
        arrayJsonArray17.ElementType = scalarJsonScalar17;
        refTypeIListViewColumn.JsonElement = arrayJsonArray17;
        var arrayJsonArray18 = new RelationalJsonArray(refTypeListViewColumn, true);
        var scalarJsonScalar18 = new RelationalJsonScalar(arrayJsonArray18, false);
        arrayJsonArray18.ElementType = scalarJsonScalar18;
        refTypeListViewColumn.JsonElement = arrayJsonArray18;
        var arrayJsonArray19 = new RelationalJsonArray(valueTypeArrayViewColumn, true);
        var scalarJsonScalar19 = new RelationalJsonScalar(arrayJsonArray19, false);
        arrayJsonArray19.ElementType = scalarJsonScalar19;
        valueTypeArrayViewColumn.JsonElement = arrayJsonArray19;
        var arrayJsonArray20 = new RelationalJsonArray(valueTypeEnumerableViewColumn, true);
        var scalarJsonScalar20 = new RelationalJsonScalar(arrayJsonArray20, false);
        arrayJsonArray20.ElementType = scalarJsonScalar20;
        valueTypeEnumerableViewColumn.JsonElement = arrayJsonArray20;
        var arrayJsonArray21 = new RelationalJsonArray(valueTypeIListViewColumn, true);
        var scalarJsonScalar21 = new RelationalJsonScalar(arrayJsonArray21, false);
        arrayJsonArray21.ElementType = scalarJsonScalar21;
        valueTypeIListViewColumn.JsonElement = arrayJsonArray21;
        var arrayJsonArray22 = new RelationalJsonArray(valueTypeListViewColumn, true);
        var scalarJsonScalar22 = new RelationalJsonScalar(arrayJsonArray22, false);
        arrayJsonArray22.ElementType = scalarJsonScalar22;
        valueTypeListViewColumn.JsonElement = arrayJsonArray22;
        ...
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeArray")!, arrayJsonArray15, principalBaseViewViewMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeEnumerable")!, arrayJsonArray16, principalBaseViewViewMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeIList")!, arrayJsonArray17, principalBaseViewViewMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeList")!, arrayJsonArray18, principalBaseViewViewMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeArray")!, arrayJsonArray19, principalBaseViewViewMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeEnumerable")!, arrayJsonArray20, principalBaseViewViewMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeIList")!, arrayJsonArray21, principalBaseViewViewMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeList")!, arrayJsonArray22, principalBaseViewViewMapping);
        ...
        var rowsAffectedParameter = new StoreStoredProcedureParameter("RowsAffected", "int", 1, principalBase_DeleteStoreSproc, System.Data.ParameterDirection.Output);
        ...
        var valueTypeListParameter = new StoreStoredProcedureParameter("ValueTypeList", "longtext", 6, principalBase_InsertStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        principalBase_InsertStoreSproc.AddParameter(valueTypeListParameter);
        var valueTypeIListParameter = new StoreStoredProcedureParameter("ValueTypeIList", "longtext", 7, principalBase_InsertStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        principalBase_InsertStoreSproc.AddParameter(valueTypeIListParameter);
        var valueTypeArrayParameter = new StoreStoredProcedureParameter("ValueTypeArray", "longtext", 8, principalBase_InsertStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        principalBase_InsertStoreSproc.AddParameter(valueTypeArrayParameter);
        var valueTypeEnumerableParameter = new StoreStoredProcedureParameter("ValueTypeEnumerable", "longtext", 9, principalBase_InsertStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        principalBase_InsertStoreSproc.AddParameter(valueTypeEnumerableParameter);
        var refTypeListParameter = new StoreStoredProcedureParameter("RefTypeList", "longtext", 10, principalBase_InsertStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        principalBase_InsertStoreSproc.AddParameter(refTypeListParameter);
        var refTypeIListParameter = new StoreStoredProcedureParameter("RefTypeIList", "longtext", 11, principalBase_InsertStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        principalBase_InsertStoreSproc.AddParameter(refTypeIListParameter);
        var refTypeArrayParameter = new StoreStoredProcedureParameter("RefTypeArray", "longtext", 12, principalBase_InsertStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        principalBase_InsertStoreSproc.AddParameter(refTypeArrayParameter);
        var refTypeEnumerableParameter = new StoreStoredProcedureParameter("RefTypeEnumerable", "longtext", 13, principalBase_InsertStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        ...
        var valueTypeListParameter0 = new StoreStoredProcedureParameter("ValueTypeList", "longtext", 6, principalBase_UpdateStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        principalBase_UpdateStoreSproc.AddParameter(valueTypeListParameter0);
        var valueTypeIListParameter0 = new StoreStoredProcedureParameter("ValueTypeIList", "longtext", 7, principalBase_UpdateStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        principalBase_UpdateStoreSproc.AddParameter(valueTypeIListParameter0);
        var valueTypeArrayParameter0 = new StoreStoredProcedureParameter("ValueTypeArray", "longtext", 8, principalBase_UpdateStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        principalBase_UpdateStoreSproc.AddParameter(valueTypeArrayParameter0);
        var valueTypeEnumerableParameter0 = new StoreStoredProcedureParameter("ValueTypeEnumerable", "longtext", 9, principalBase_UpdateStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        principalBase_UpdateStoreSproc.AddParameter(valueTypeEnumerableParameter0);
        var refTypeListParameter0 = new StoreStoredProcedureParameter("RefTypeList", "longtext", 10, principalBase_UpdateStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        principalBase_UpdateStoreSproc.AddParameter(refTypeListParameter0);
        var refTypeIListParameter0 = new StoreStoredProcedureParameter("RefTypeIList", "longtext", 11, principalBase_UpdateStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        principalBase_UpdateStoreSproc.AddParameter(refTypeIListParameter0);
        var refTypeArrayParameter0 = new StoreStoredProcedureParameter("RefTypeArray", "longtext", 12, principalBase_UpdateStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        principalBase_UpdateStoreSproc.AddParameter(refTypeArrayParameter0);
        var refTypeEnumerableParameter0 = new StoreStoredProcedureParameter("RefTypeEnumerable", "longtext", 13, principalBase_UpdateStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        ...
        var refTypeArrayColumnBase0 = new ColumnBase<ColumnMappingBase>("RefTypeArray", "longtext", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteTableBase)
        {
            IsNullable = true
        };
        ...
        var refTypeEnumerableColumnBase0 = new ColumnBase<ColumnMappingBase>("RefTypeEnumerable", "longtext", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteTableBase)
        {
            IsNullable = true
        };
        ...
        var refTypeIListColumnBase0 = new ColumnBase<ColumnMappingBase>("RefTypeIList", "longtext", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteTableBase)
        {
            IsNullable = true
        };
        ...
        var refTypeListColumnBase0 = new ColumnBase<ColumnMappingBase>("RefTypeList", "longtext", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteTableBase)
        {
            IsNullable = true
        };
        ...
        var valueTypeArrayColumnBase0 = new ColumnBase<ColumnMappingBase>("ValueTypeArray", "longtext", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteTableBase)
        {
            IsNullable = true
        };
        ...
        var valueTypeEnumerableColumnBase0 = new ColumnBase<ColumnMappingBase>("ValueTypeEnumerable", "longtext", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteTableBase)
        {
            IsNullable = true
        };
        ...
        var valueTypeIListColumnBase0 = new ColumnBase<ColumnMappingBase>("ValueTypeIList", "longtext", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteTableBase)
        {
            IsNullable = true
        };
        ...
        var valueTypeListColumnBase0 = new ColumnBase<ColumnMappingBase>("ValueTypeList", "longtext", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteTableBase)
        {
            IsNullable = true
        };
        ...
        var arrayJsonArray23 = new RelationalJsonArray(refTypeArrayColumnBase0, true);
        var scalarJsonScalar23 = new RelationalJsonScalar(arrayJsonArray23, false);
        arrayJsonArray23.ElementType = scalarJsonScalar23;
        refTypeArrayColumnBase0.JsonElement = arrayJsonArray23;
        var arrayJsonArray24 = new RelationalJsonArray(refTypeEnumerableColumnBase0, true);
        var scalarJsonScalar24 = new RelationalJsonScalar(arrayJsonArray24, false);
        arrayJsonArray24.ElementType = scalarJsonScalar24;
        refTypeEnumerableColumnBase0.JsonElement = arrayJsonArray24;
        var arrayJsonArray25 = new RelationalJsonArray(refTypeIListColumnBase0, true);
        var scalarJsonScalar25 = new RelationalJsonScalar(arrayJsonArray25, false);
        arrayJsonArray25.ElementType = scalarJsonScalar25;
        refTypeIListColumnBase0.JsonElement = arrayJsonArray25;
        var arrayJsonArray26 = new RelationalJsonArray(refTypeListColumnBase0, true);
        var scalarJsonScalar26 = new RelationalJsonScalar(arrayJsonArray26, false);
        arrayJsonArray26.ElementType = scalarJsonScalar26;
        refTypeListColumnBase0.JsonElement = arrayJsonArray26;
        var arrayJsonArray27 = new RelationalJsonArray(valueTypeArrayColumnBase0, true);
        var scalarJsonScalar27 = new RelationalJsonScalar(arrayJsonArray27, false);
        arrayJsonArray27.ElementType = scalarJsonScalar27;
        valueTypeArrayColumnBase0.JsonElement = arrayJsonArray27;
        var arrayJsonArray28 = new RelationalJsonArray(valueTypeEnumerableColumnBase0, true);
        var scalarJsonScalar28 = new RelationalJsonScalar(arrayJsonArray28, false);
        arrayJsonArray28.ElementType = scalarJsonScalar28;
        valueTypeEnumerableColumnBase0.JsonElement = arrayJsonArray28;
        var arrayJsonArray29 = new RelationalJsonArray(valueTypeIListColumnBase0, true);
        var scalarJsonScalar29 = new RelationalJsonScalar(arrayJsonArray29, false);
        arrayJsonArray29.ElementType = scalarJsonScalar29;
        valueTypeIListColumnBase0.JsonElement = arrayJsonArray29;
        var arrayJsonArray30 = new RelationalJsonArray(valueTypeListColumnBase0, true);
        var scalarJsonScalar30 = new RelationalJsonScalar(arrayJsonArray30, false);
        arrayJsonArray30.ElementType = scalarJsonScalar30;
        valueTypeListColumnBase0.JsonElement = arrayJsonArray30;
        ...
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeArray")!, arrayJsonArray23, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteMappingBase);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeEnumerable")!, arrayJsonArray24, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteMappingBase);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeIList")!, arrayJsonArray25, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteMappingBase);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeList")!, arrayJsonArray26, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteMappingBase);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeArray")!, arrayJsonArray27, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteMappingBase);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeEnumerable")!, arrayJsonArray28, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteMappingBase);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeIList")!, arrayJsonArray29, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteMappingBase);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeList")!, arrayJsonArray30, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalDerivedMicrosoftEntityFrameworkCoreScaffoldingCompiledModelTestBaseDependentBasebyteMappingBase);
        ...
        var refTypeArrayColumn0 = new Column("RefTypeArray", "longtext", principalDerivedTable)
        {
            IsNullable = true
        };
        ...
        var refTypeEnumerableColumn0 = new Column("RefTypeEnumerable", "longtext", principalDerivedTable)
        {
            IsNullable = true
        };
        ...
        var refTypeIListColumn0 = new Column("RefTypeIList", "longtext", principalDerivedTable)
        {
            IsNullable = true
        };
        ...
        var refTypeListColumn0 = new Column("RefTypeList", "longtext", principalDerivedTable)
        {
            IsNullable = true
        };
        ...
        var valueTypeArrayColumn0 = new Column("ValueTypeArray", "longtext", principalDerivedTable)
        {
            IsNullable = true
        };
        ...
        var valueTypeEnumerableColumn0 = new Column("ValueTypeEnumerable", "longtext", principalDerivedTable)
        {
            IsNullable = true
        };
        ...
        var valueTypeIListColumn0 = new Column("ValueTypeIList", "longtext", principalDerivedTable)
        {
            IsNullable = true
        };
        ...
        var valueTypeListColumn0 = new Column("ValueTypeList", "longtext", principalDerivedTable)
        {
            IsNullable = true
        };
        ...
        var arrayJsonArray31 = new RelationalJsonArray(refTypeArrayColumn0, true);
        var scalarJsonScalar31 = new RelationalJsonScalar(arrayJsonArray31, false);
        arrayJsonArray31.ElementType = scalarJsonScalar31;
        refTypeArrayColumn0.JsonElement = arrayJsonArray31;
        var arrayJsonArray32 = new RelationalJsonArray(refTypeEnumerableColumn0, true);
        var scalarJsonScalar32 = new RelationalJsonScalar(arrayJsonArray32, false);
        arrayJsonArray32.ElementType = scalarJsonScalar32;
        refTypeEnumerableColumn0.JsonElement = arrayJsonArray32;
        var arrayJsonArray33 = new RelationalJsonArray(refTypeIListColumn0, true);
        var scalarJsonScalar33 = new RelationalJsonScalar(arrayJsonArray33, false);
        arrayJsonArray33.ElementType = scalarJsonScalar33;
        refTypeIListColumn0.JsonElement = arrayJsonArray33;
        var arrayJsonArray34 = new RelationalJsonArray(refTypeListColumn0, true);
        var scalarJsonScalar34 = new RelationalJsonScalar(arrayJsonArray34, false);
        arrayJsonArray34.ElementType = scalarJsonScalar34;
        refTypeListColumn0.JsonElement = arrayJsonArray34;
        var arrayJsonArray35 = new RelationalJsonArray(valueTypeArrayColumn0, true);
        var scalarJsonScalar35 = new RelationalJsonScalar(arrayJsonArray35, false);
        arrayJsonArray35.ElementType = scalarJsonScalar35;
        valueTypeArrayColumn0.JsonElement = arrayJsonArray35;
        var arrayJsonArray36 = new RelationalJsonArray(valueTypeEnumerableColumn0, true);
        var scalarJsonScalar36 = new RelationalJsonScalar(arrayJsonArray36, false);
        arrayJsonArray36.ElementType = scalarJsonScalar36;
        valueTypeEnumerableColumn0.JsonElement = arrayJsonArray36;
        var arrayJsonArray37 = new RelationalJsonArray(valueTypeIListColumn0, true);
        var scalarJsonScalar37 = new RelationalJsonScalar(arrayJsonArray37, false);
        arrayJsonArray37.ElementType = scalarJsonScalar37;
        valueTypeIListColumn0.JsonElement = arrayJsonArray37;
        var arrayJsonArray38 = new RelationalJsonArray(valueTypeListColumn0, true);
        var scalarJsonScalar38 = new RelationalJsonScalar(arrayJsonArray38, false);
        arrayJsonArray38.ElementType = scalarJsonScalar38;
        valueTypeListColumn0.JsonElement = arrayJsonArray38;
        ...
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeArray")!, arrayJsonArray31, principalDerivedTableMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeEnumerable")!, arrayJsonArray32, principalDerivedTableMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeIList")!, arrayJsonArray33, principalDerivedTableMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeList")!, arrayJsonArray34, principalDerivedTableMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeArray")!, arrayJsonArray35, principalDerivedTableMapping);
        ...
        var refTypeArrayViewColumn0 = new ViewColumn("RefTypeArray", "longtext", principalDerivedViewView)
        {
            IsNullable = true
        };
        principalDerivedViewView.Columns.Add("RefTypeArray", refTypeArrayViewColumn0);
        var refTypeEnumerableViewColumn0 = new ViewColumn("RefTypeEnumerable", "longtext", principalDerivedViewView)
        {
            IsNullable = true
        };
        principalDerivedViewView.Columns.Add("RefTypeEnumerable", refTypeEnumerableViewColumn0);
        var refTypeIListViewColumn0 = new ViewColumn("RefTypeIList", "longtext", principalDerivedViewView)
        {
            IsNullable = true
        };
        principalDerivedViewView.Columns.Add("RefTypeIList", refTypeIListViewColumn0);
        var refTypeListViewColumn0 = new ViewColumn("RefTypeList", "longtext", principalDerivedViewView)
        {
            IsNullable = true
        };
        principalDerivedViewView.Columns.Add("RefTypeList", refTypeListViewColumn0);
        var valueTypeArrayViewColumn0 = new ViewColumn("ValueTypeArray", "longtext", principalDerivedViewView)
        {
            IsNullable = true
        };
        principalDerivedViewView.Columns.Add("ValueTypeArray", valueTypeArrayViewColumn0);
        var valueTypeEnumerableViewColumn0 = new ViewColumn("ValueTypeEnumerable", "longtext", principalDerivedViewView)
        {
            IsNullable = true
        };
        principalDerivedViewView.Columns.Add("ValueTypeEnumerable", valueTypeEnumerableViewColumn0);
        var valueTypeIListViewColumn0 = new ViewColumn("ValueTypeIList", "longtext", principalDerivedViewView)
        {
            IsNullable = true
        };
        principalDerivedViewView.Columns.Add("ValueTypeIList", valueTypeIListViewColumn0);
        var valueTypeListViewColumn0 = new ViewColumn("ValueTypeList", "longtext", principalDerivedViewView)
        {
            IsNullable = true
        };
        principalDerivedViewView.Columns.Add("ValueTypeList", valueTypeListViewColumn0);
        var arrayJsonArray39 = new RelationalJsonArray(refTypeArrayViewColumn0, true);
        var scalarJsonScalar39 = new RelationalJsonScalar(arrayJsonArray39, false);
        arrayJsonArray39.ElementType = scalarJsonScalar39;
        refTypeArrayViewColumn0.JsonElement = arrayJsonArray39;
        var arrayJsonArray40 = new RelationalJsonArray(refTypeEnumerableViewColumn0, true);
        var scalarJsonScalar40 = new RelationalJsonScalar(arrayJsonArray40, false);
        arrayJsonArray40.ElementType = scalarJsonScalar40;
        refTypeEnumerableViewColumn0.JsonElement = arrayJsonArray40;
        var arrayJsonArray41 = new RelationalJsonArray(refTypeIListViewColumn0, true);
        var scalarJsonScalar41 = new RelationalJsonScalar(arrayJsonArray41, false);
        arrayJsonArray41.ElementType = scalarJsonScalar41;
        refTypeIListViewColumn0.JsonElement = arrayJsonArray41;
        var arrayJsonArray42 = new RelationalJsonArray(refTypeListViewColumn0, true);
        var scalarJsonScalar42 = new RelationalJsonScalar(arrayJsonArray42, false);
        arrayJsonArray42.ElementType = scalarJsonScalar42;
        refTypeListViewColumn0.JsonElement = arrayJsonArray42;
        var arrayJsonArray43 = new RelationalJsonArray(valueTypeArrayViewColumn0, true);
        var scalarJsonScalar43 = new RelationalJsonScalar(arrayJsonArray43, false);
        arrayJsonArray43.ElementType = scalarJsonScalar43;
        valueTypeArrayViewColumn0.JsonElement = arrayJsonArray43;
        var arrayJsonArray44 = new RelationalJsonArray(valueTypeEnumerableViewColumn0, true);
        var scalarJsonScalar44 = new RelationalJsonScalar(arrayJsonArray44, false);
        arrayJsonArray44.ElementType = scalarJsonScalar44;
        valueTypeEnumerableViewColumn0.JsonElement = arrayJsonArray44;
        var arrayJsonArray45 = new RelationalJsonArray(valueTypeIListViewColumn0, true);
        var scalarJsonScalar45 = new RelationalJsonScalar(arrayJsonArray45, false);
        arrayJsonArray45.ElementType = scalarJsonScalar45;
        valueTypeIListViewColumn0.JsonElement = arrayJsonArray45;
        var arrayJsonArray46 = new RelationalJsonArray(valueTypeListViewColumn0, true);
        var scalarJsonScalar46 = new RelationalJsonScalar(arrayJsonArray46, false);
        arrayJsonArray46.ElementType = scalarJsonScalar46;
        valueTypeListViewColumn0.JsonElement = arrayJsonArray46;
        ...
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeArray")!, arrayJsonArray39, principalDerivedViewViewMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeEnumerable")!, arrayJsonArray40, principalDerivedViewViewMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeIList")!, arrayJsonArray41, principalDerivedViewViewMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeList")!, arrayJsonArray42, principalDerivedViewViewMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeArray")!, arrayJsonArray43, principalDerivedViewViewMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeEnumerable")!, arrayJsonArray44, principalDerivedViewViewMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeIList")!, arrayJsonArray45, principalDerivedViewViewMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeList")!, arrayJsonArray46, principalDerivedViewViewMapping);
        ...
        var valueTypeListParameter1 = new StoreStoredProcedureParameter("ValueTypeList", "longtext", 6, derived_InsertStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        derived_InsertStoreSproc.AddParameter(valueTypeListParameter1);
        var valueTypeIListParameter1 = new StoreStoredProcedureParameter("ValueTypeIList", "longtext", 7, derived_InsertStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        derived_InsertStoreSproc.AddParameter(valueTypeIListParameter1);
        var valueTypeArrayParameter1 = new StoreStoredProcedureParameter("ValueTypeArray", "longtext", 8, derived_InsertStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        derived_InsertStoreSproc.AddParameter(valueTypeArrayParameter1);
        var valueTypeEnumerableParameter1 = new StoreStoredProcedureParameter("ValueTypeEnumerable", "longtext", 9, derived_InsertStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        derived_InsertStoreSproc.AddParameter(valueTypeEnumerableParameter1);
        var refTypeListParameter1 = new StoreStoredProcedureParameter("RefTypeList", "longtext", 10, derived_InsertStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        derived_InsertStoreSproc.AddParameter(refTypeListParameter1);
        var refTypeIListParameter1 = new StoreStoredProcedureParameter("RefTypeIList", "longtext", 11, derived_InsertStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        derived_InsertStoreSproc.AddParameter(refTypeIListParameter1);
        var refTypeArrayParameter1 = new StoreStoredProcedureParameter("RefTypeArray", "longtext", 12, derived_InsertStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        derived_InsertStoreSproc.AddParameter(refTypeArrayParameter1);
        var refTypeEnumerableParameter1 = new StoreStoredProcedureParameter("RefTypeEnumerable", "longtext", 13, derived_InsertStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        ...
        var valueTypeListParameter2 = new StoreStoredProcedureParameter("ValueTypeList", "longtext", 6, derived_UpdateStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        derived_UpdateStoreSproc.AddParameter(valueTypeListParameter2);
        var valueTypeIListParameter2 = new StoreStoredProcedureParameter("ValueTypeIList", "longtext", 7, derived_UpdateStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        derived_UpdateStoreSproc.AddParameter(valueTypeIListParameter2);
        var valueTypeArrayParameter2 = new StoreStoredProcedureParameter("ValueTypeArray", "longtext", 8, derived_UpdateStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        derived_UpdateStoreSproc.AddParameter(valueTypeArrayParameter2);
        var valueTypeEnumerableParameter2 = new StoreStoredProcedureParameter("ValueTypeEnumerable", "longtext", 9, derived_UpdateStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        derived_UpdateStoreSproc.AddParameter(valueTypeEnumerableParameter2);
        var refTypeListParameter2 = new StoreStoredProcedureParameter("RefTypeList", "longtext", 10, derived_UpdateStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        derived_UpdateStoreSproc.AddParameter(refTypeListParameter2);
        var refTypeIListParameter2 = new StoreStoredProcedureParameter("RefTypeIList", "longtext", 11, derived_UpdateStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        derived_UpdateStoreSproc.AddParameter(refTypeIListParameter2);
        var refTypeArrayParameter2 = new StoreStoredProcedureParameter("RefTypeArray", "longtext", 12, derived_UpdateStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        derived_UpdateStoreSproc.AddParameter(refTypeArrayParameter2);
        var refTypeEnumerableParameter2 = new StoreStoredProcedureParameter("RefTypeEnumerable", "longtext", 13, derived_UpdateStoreSproc, System.Data.ParameterDirection.Input)
        {
            IsNullable = true
        };
        ...
        var fK_PrincipalBase_PrincipalDerived_PrincipalDerivedDependentBas = new ForeignKeyConstraint(
            "FK_PrincipalBase_PrincipalDerived_PrincipalDerived<DependentBas~", principalBaseTable, principalDerivedTable,
            new[] { principalDerivedDependentBasebyteIdColumn },
            principalDerivedTable.FindUniqueConstraint("PK_PrincipalDerived")!, ReferentialAction.NoAction);
        fK_PrincipalBase_PrincipalDerived_PrincipalDerivedDependentBas.SetRowForeignKeyValueFactory(RowForeignKeyValueFactoryFactory.CreateSimpleNonNullableFactory<long, long>(fK_PrincipalBase_PrincipalDerived_PrincipalDerivedDependentBas));
        var fK_PrincipalBase_PrincipalDerived_PrincipalDerivedDependentBasFk = RelationalModel.GetForeignKey(this,
            "Microsoft.EntityFrameworkCore.Scaffolding.CompiledModelTestBase+PrincipalBase",
            new[] { "PrincipalDerivedId" },
            "Microsoft.EntityFrameworkCore.Scaffolding.CompiledModelTestBase+PrincipalDerived<Microsoft.EntityFrameworkCore.Scaffolding.CompiledModelTestBase+DependentBase<byte?>>",
            new[] { "Id" });
        fK_PrincipalBase_PrincipalDerived_PrincipalDerivedDependentBas.MappedForeignKeys.Add(fK_PrincipalBase_PrincipalDerived_PrincipalDerivedDependentBasFk);
        RelationalModel.GetOrCreateForeignKeyConstraints(fK_PrincipalBase_PrincipalDerived_PrincipalDerivedDependentBasFk).Add(fK_PrincipalBase_PrincipalDerived_PrincipalDerivedDependentBas);
        principalBaseTable.ForeignKeyConstraints.Add(fK_PrincipalBase_PrincipalDerived_PrincipalDerivedDependentBas);
        principalDerivedTable.ReferencingForeignKeyConstraints.Add(fK_PrincipalBase_PrincipalDerived_PrincipalDerivedDependentBas);
        var fK_PrincipalDerived_PrincipalDerived_PrincipalDerivedDependent = new ForeignKeyConstraint(
            "FK_PrincipalDerived_PrincipalDerived_PrincipalDerived<Dependent~", principalDerivedTable, principalDerivedTable,
            new[] { principalDerivedDependentBasebyteIdColumn0 },
            principalDerivedTable.FindUniqueConstraint("PK_PrincipalDerived")!, ReferentialAction.NoAction);
        fK_PrincipalDerived_PrincipalDerived_PrincipalDerivedDependent.SetRowForeignKeyValueFactory(RowForeignKeyValueFactoryFactory.CreateSimpleNonNullableFactory<long, long>(fK_PrincipalDerived_PrincipalDerived_PrincipalDerivedDependent));
        fK_PrincipalDerived_PrincipalDerived_PrincipalDerivedDependent.MappedForeignKeys.Add(fK_PrincipalBase_PrincipalDerived_PrincipalDerivedDependentBasFk);
        RelationalModel.GetOrCreateForeignKeyConstraints(fK_PrincipalBase_PrincipalDerived_PrincipalDerivedDependentBasFk).Add(fK_PrincipalDerived_PrincipalDerived_PrincipalDerivedDependent);
        principalDerivedTable.ForeignKeyConstraints.Add(fK_PrincipalDerived_PrincipalDerived_PrincipalDerivedDependent);
        principalDerivedTable.ReferencingForeignKeyConstraints.Add(fK_PrincipalDerived_PrincipalDerived_PrincipalDerivedDependent);
