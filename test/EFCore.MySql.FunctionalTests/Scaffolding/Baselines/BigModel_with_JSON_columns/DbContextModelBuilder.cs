...
public partial class DbContextModel
{
    ...
    private IRelationalModel CreateRelationalModel()
    {
        ...
        var discriminatorColumnBase = new ColumnBase<ColumnMappingBase>("Discriminator", "varchar(55)", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseTableBase);
        ...
        var manyOwnedColumnBase = new JsonColumnBase("ManyOwned", "json", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseTableBase)
        {
            IsNullable = true
        };
        ...
        var ownedColumnBase = new JsonColumnBase("Owned", "json", microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseTableBase);
        ...
        var arrayJsonArray227 = new RelationalJsonArray(manyOwnedColumnBase, true);
        var elementJsonObject = new RelationalJsonObject(arrayJsonArray227, false);
        var principalDerivedIdJsonScalar = new RelationalJsonScalar("PrincipalDerivedId", elementJsonObject, false);
        elementJsonObject.AddProperty(principalDerivedIdJsonScalar);
        var principalDerivedAlternateIdJsonScalar = new RelationalJsonScalar("PrincipalDerivedAlternateId", elementJsonObject, false);
        elementJsonObject.AddProperty(principalDerivedAlternateIdJsonScalar);
        var __synthesizedOrdinalJsonScalar = new RelationalJsonScalar("__synthesizedOrdinal", elementJsonObject, false);
        elementJsonObject.AddProperty(__synthesizedOrdinalJsonScalar);
        ...
        var scalarJsonScalar227 = new RelationalJsonScalar(refTypeArrayJsonArray, false);
        refTypeArrayJsonArray.ElementType = scalarJsonScalar227;
        ...
        var scalarJsonScalar228 = new RelationalJsonScalar(refTypeEnumerableJsonArray, false);
        refTypeEnumerableJsonArray.ElementType = scalarJsonScalar228;
        ...
        var scalarJsonScalar229 = new RelationalJsonScalar(refTypeIListJsonArray, false);
        refTypeIListJsonArray.ElementType = scalarJsonScalar229;
        ...
        var scalarJsonScalar230 = new RelationalJsonScalar(refTypeListJsonArray, false);
        refTypeListJsonArray.ElementType = scalarJsonScalar230;
        ...
        var scalarJsonScalar231 = new RelationalJsonScalar(valueTypeArrayJsonArray, false);
        valueTypeArrayJsonArray.ElementType = scalarJsonScalar231;
        ...
        var scalarJsonScalar232 = new RelationalJsonScalar(valueTypeEnumerableJsonArray, false);
        valueTypeEnumerableJsonArray.ElementType = scalarJsonScalar232;
        ...
        var scalarJsonScalar233 = new RelationalJsonScalar(valueTypeIListJsonArray, false);
        valueTypeIListJsonArray.ElementType = scalarJsonScalar233;
        ...
        var scalarJsonScalar234 = new RelationalJsonScalar(valueTypeListJsonArray, false);
        valueTypeListJsonArray.ElementType = scalarJsonScalar234;
        elementJsonObject.AddProperty(valueTypeListJsonArray);
        arrayJsonArray227.ElementType = elementJsonObject;
        manyOwnedColumnBase.JsonElement = arrayJsonArray227;
        var elementJsonObject0 = new RelationalJsonObject(ownedColumnBase, false);
        var principalBaseIdJsonScalar = new RelationalJsonScalar("PrincipalBaseId", elementJsonObject0, false);
        elementJsonObject0.AddProperty(principalBaseIdJsonScalar);
        var principalBaseAlternateIdJsonScalar = new RelationalJsonScalar("PrincipalBaseAlternateId", elementJsonObject0, false);
        elementJsonObject0.AddProperty(principalBaseAlternateIdJsonScalar);
        var detailsJsonScalar0 = new RelationalJsonScalar("Details", elementJsonObject0, true);
        elementJsonObject0.AddProperty(detailsJsonScalar0);
        var numberJsonScalar0 = new RelationalJsonScalar("Number", elementJsonObject0, false);
        elementJsonObject0.AddProperty(numberJsonScalar0);
        var refTypeArrayJsonArray0 = new RelationalJsonArray("RefTypeArray", elementJsonObject0, true);
        var scalarJsonScalar235 = new RelationalJsonScalar(refTypeArrayJsonArray0, false);
        refTypeArrayJsonArray0.ElementType = scalarJsonScalar235;
        elementJsonObject0.AddProperty(refTypeArrayJsonArray0);
        var refTypeEnumerableJsonArray0 = new RelationalJsonArray("RefTypeEnumerable", elementJsonObject0, true);
        var scalarJsonScalar236 = new RelationalJsonScalar(refTypeEnumerableJsonArray0, false);
        refTypeEnumerableJsonArray0.ElementType = scalarJsonScalar236;
        elementJsonObject0.AddProperty(refTypeEnumerableJsonArray0);
        var refTypeIListJsonArray0 = new RelationalJsonArray("RefTypeIList", elementJsonObject0, true);
        var scalarJsonScalar237 = new RelationalJsonScalar(refTypeIListJsonArray0, false);
        refTypeIListJsonArray0.ElementType = scalarJsonScalar237;
        elementJsonObject0.AddProperty(refTypeIListJsonArray0);
        var refTypeListJsonArray0 = new RelationalJsonArray("RefTypeList", elementJsonObject0, true);
        var scalarJsonScalar238 = new RelationalJsonScalar(refTypeListJsonArray0, false);
        refTypeListJsonArray0.ElementType = scalarJsonScalar238;
        elementJsonObject0.AddProperty(refTypeListJsonArray0);
        var valueTypeArrayJsonArray0 = new RelationalJsonArray("ValueTypeArray", elementJsonObject0, true);
        var scalarJsonScalar239 = new RelationalJsonScalar(valueTypeArrayJsonArray0, false);
        valueTypeArrayJsonArray0.ElementType = scalarJsonScalar239;
        elementJsonObject0.AddProperty(valueTypeArrayJsonArray0);
        var valueTypeEnumerableJsonArray0 = new RelationalJsonArray("ValueTypeEnumerable", elementJsonObject0, true);
        var scalarJsonScalar240 = new RelationalJsonScalar(valueTypeEnumerableJsonArray0, false);
        valueTypeEnumerableJsonArray0.ElementType = scalarJsonScalar240;
        elementJsonObject0.AddProperty(valueTypeEnumerableJsonArray0);
        var valueTypeIListJsonArray0 = new RelationalJsonArray("ValueTypeIList", elementJsonObject0, true);
        var scalarJsonScalar241 = new RelationalJsonScalar(valueTypeIListJsonArray0, false);
        valueTypeIListJsonArray0.ElementType = scalarJsonScalar241;
        elementJsonObject0.AddProperty(valueTypeIListJsonArray0);
        var valueTypeListJsonArray0 = new RelationalJsonArray("ValueTypeList", elementJsonObject0, true);
        var scalarJsonScalar242 = new RelationalJsonScalar(valueTypeListJsonArray0, false);
        valueTypeListJsonArray0.ElementType = scalarJsonScalar242;
        elementJsonObject0.AddProperty(valueTypeListJsonArray0);
        ownedColumnBase.JsonElement = elementJsonObject0;
        var arrayJsonArray228 = new RelationalJsonArray(refTypeArrayColumnBase, true);
        var scalarJsonScalar243 = new RelationalJsonScalar(arrayJsonArray228, false);
        arrayJsonArray228.ElementType = scalarJsonScalar243;
        refTypeArrayColumnBase.JsonElement = arrayJsonArray228;
        var arrayJsonArray229 = new RelationalJsonArray(refTypeEnumerableColumnBase, true);
        var scalarJsonScalar244 = new RelationalJsonScalar(arrayJsonArray229, false);
        arrayJsonArray229.ElementType = scalarJsonScalar244;
        refTypeEnumerableColumnBase.JsonElement = arrayJsonArray229;
        var arrayJsonArray230 = new RelationalJsonArray(refTypeIListColumnBase, true);
        var scalarJsonScalar245 = new RelationalJsonScalar(arrayJsonArray230, false);
        arrayJsonArray230.ElementType = scalarJsonScalar245;
        refTypeIListColumnBase.JsonElement = arrayJsonArray230;
        var arrayJsonArray231 = new RelationalJsonArray(refTypeListColumnBase, true);
        var scalarJsonScalar246 = new RelationalJsonScalar(arrayJsonArray231, false);
        arrayJsonArray231.ElementType = scalarJsonScalar246;
        refTypeListColumnBase.JsonElement = arrayJsonArray231;
        var arrayJsonArray232 = new RelationalJsonArray(valueTypeArrayColumnBase, true);
        var scalarJsonScalar247 = new RelationalJsonScalar(arrayJsonArray232, false);
        arrayJsonArray232.ElementType = scalarJsonScalar247;
        valueTypeArrayColumnBase.JsonElement = arrayJsonArray232;
        var arrayJsonArray233 = new RelationalJsonArray(valueTypeEnumerableColumnBase, true);
        var scalarJsonScalar248 = new RelationalJsonScalar(arrayJsonArray233, false);
        arrayJsonArray233.ElementType = scalarJsonScalar248;
        valueTypeEnumerableColumnBase.JsonElement = arrayJsonArray233;
        var arrayJsonArray234 = new RelationalJsonArray(valueTypeIListColumnBase, true);
        var scalarJsonScalar249 = new RelationalJsonScalar(arrayJsonArray234, false);
        arrayJsonArray234.ElementType = scalarJsonScalar249;
        valueTypeIListColumnBase.JsonElement = arrayJsonArray234;
        var arrayJsonArray235 = new RelationalJsonArray(valueTypeListColumnBase, true);
        var scalarJsonScalar250 = new RelationalJsonScalar(arrayJsonArray235, false);
        arrayJsonArray235.ElementType = scalarJsonScalar250;
        valueTypeListColumnBase.JsonElement = arrayJsonArray235;
        ...
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeArray")!, arrayJsonArray228, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeEnumerable")!, arrayJsonArray229, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeIList")!, arrayJsonArray230, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeList")!, arrayJsonArray231, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeArray")!, arrayJsonArray232, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeEnumerable")!, arrayJsonArray233, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeIList")!, arrayJsonArray234, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeList")!, arrayJsonArray235, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase);
        ...
        var discriminatorColumn = new Column("Discriminator", "varchar(55)", principalBaseTable);
        ...
        var ownedColumn = new JsonColumn("Owned", "json", principalBaseTable);
        ...
        var arrayJsonArray236 = new RelationalJsonArray(manyOwnedColumn, true);
        var elementJsonObject1 = new RelationalJsonObject(arrayJsonArray236, false);
        var principalDerivedIdJsonScalar0 = new RelationalJsonScalar("PrincipalDerivedId", elementJsonObject1, false);
        elementJsonObject1.AddProperty(principalDerivedIdJsonScalar0);
        var principalDerivedAlternateIdJsonScalar0 = new RelationalJsonScalar("PrincipalDerivedAlternateId", elementJsonObject1, false);
        elementJsonObject1.AddProperty(principalDerivedAlternateIdJsonScalar0);
        var __synthesizedOrdinalJsonScalar0 = new RelationalJsonScalar("__synthesizedOrdinal", elementJsonObject1, false);
        elementJsonObject1.AddProperty(__synthesizedOrdinalJsonScalar0);
        var detailsJsonScalar1 = new RelationalJsonScalar("Details", elementJsonObject1, true);
        elementJsonObject1.AddProperty(detailsJsonScalar1);
        var numberJsonScalar1 = new RelationalJsonScalar("Number", elementJsonObject1, false);
        elementJsonObject1.AddProperty(numberJsonScalar1);
        var refTypeArrayJsonArray1 = new RelationalJsonArray("RefTypeArray", elementJsonObject1, true);
        var scalarJsonScalar251 = new RelationalJsonScalar(refTypeArrayJsonArray1, false);
        refTypeArrayJsonArray1.ElementType = scalarJsonScalar251;
        elementJsonObject1.AddProperty(refTypeArrayJsonArray1);
        var refTypeEnumerableJsonArray1 = new RelationalJsonArray("RefTypeEnumerable", elementJsonObject1, true);
        var scalarJsonScalar252 = new RelationalJsonScalar(refTypeEnumerableJsonArray1, false);
        refTypeEnumerableJsonArray1.ElementType = scalarJsonScalar252;
        elementJsonObject1.AddProperty(refTypeEnumerableJsonArray1);
        var refTypeIListJsonArray1 = new RelationalJsonArray("RefTypeIList", elementJsonObject1, true);
        var scalarJsonScalar253 = new RelationalJsonScalar(refTypeIListJsonArray1, false);
        refTypeIListJsonArray1.ElementType = scalarJsonScalar253;
        elementJsonObject1.AddProperty(refTypeIListJsonArray1);
        var refTypeListJsonArray1 = new RelationalJsonArray("RefTypeList", elementJsonObject1, true);
        var scalarJsonScalar254 = new RelationalJsonScalar(refTypeListJsonArray1, false);
        refTypeListJsonArray1.ElementType = scalarJsonScalar254;
        elementJsonObject1.AddProperty(refTypeListJsonArray1);
        var valueTypeArrayJsonArray1 = new RelationalJsonArray("ValueTypeArray", elementJsonObject1, true);
        var scalarJsonScalar255 = new RelationalJsonScalar(valueTypeArrayJsonArray1, false);
        valueTypeArrayJsonArray1.ElementType = scalarJsonScalar255;
        elementJsonObject1.AddProperty(valueTypeArrayJsonArray1);
        var valueTypeEnumerableJsonArray1 = new RelationalJsonArray("ValueTypeEnumerable", elementJsonObject1, true);
        var scalarJsonScalar256 = new RelationalJsonScalar(valueTypeEnumerableJsonArray1, false);
        valueTypeEnumerableJsonArray1.ElementType = scalarJsonScalar256;
        elementJsonObject1.AddProperty(valueTypeEnumerableJsonArray1);
        var valueTypeIListJsonArray1 = new RelationalJsonArray("ValueTypeIList", elementJsonObject1, true);
        var scalarJsonScalar257 = new RelationalJsonScalar(valueTypeIListJsonArray1, false);
        valueTypeIListJsonArray1.ElementType = scalarJsonScalar257;
        elementJsonObject1.AddProperty(valueTypeIListJsonArray1);
        var valueTypeListJsonArray1 = new RelationalJsonArray("ValueTypeList", elementJsonObject1, true);
        var scalarJsonScalar258 = new RelationalJsonScalar(valueTypeListJsonArray1, false);
        valueTypeListJsonArray1.ElementType = scalarJsonScalar258;
        elementJsonObject1.AddProperty(valueTypeListJsonArray1);
        arrayJsonArray236.ElementType = elementJsonObject1;
        manyOwnedColumn.JsonElement = arrayJsonArray236;
        var elementJsonObject2 = new RelationalJsonObject(ownedColumn, false);
        var principalBaseIdJsonScalar0 = new RelationalJsonScalar("PrincipalBaseId", elementJsonObject2, false);
        elementJsonObject2.AddProperty(principalBaseIdJsonScalar0);
        var principalBaseAlternateIdJsonScalar0 = new RelationalJsonScalar("PrincipalBaseAlternateId", elementJsonObject2, false);
        elementJsonObject2.AddProperty(principalBaseAlternateIdJsonScalar0);
        var detailsJsonScalar2 = new RelationalJsonScalar("Details", elementJsonObject2, true);
        elementJsonObject2.AddProperty(detailsJsonScalar2);
        var numberJsonScalar2 = new RelationalJsonScalar("Number", elementJsonObject2, false);
        elementJsonObject2.AddProperty(numberJsonScalar2);
        var refTypeArrayJsonArray2 = new RelationalJsonArray("RefTypeArray", elementJsonObject2, true);
        var scalarJsonScalar259 = new RelationalJsonScalar(refTypeArrayJsonArray2, false);
        refTypeArrayJsonArray2.ElementType = scalarJsonScalar259;
        elementJsonObject2.AddProperty(refTypeArrayJsonArray2);
        var refTypeEnumerableJsonArray2 = new RelationalJsonArray("RefTypeEnumerable", elementJsonObject2, true);
        var scalarJsonScalar260 = new RelationalJsonScalar(refTypeEnumerableJsonArray2, false);
        refTypeEnumerableJsonArray2.ElementType = scalarJsonScalar260;
        elementJsonObject2.AddProperty(refTypeEnumerableJsonArray2);
        var refTypeIListJsonArray2 = new RelationalJsonArray("RefTypeIList", elementJsonObject2, true);
        var scalarJsonScalar261 = new RelationalJsonScalar(refTypeIListJsonArray2, false);
        refTypeIListJsonArray2.ElementType = scalarJsonScalar261;
        elementJsonObject2.AddProperty(refTypeIListJsonArray2);
        var refTypeListJsonArray2 = new RelationalJsonArray("RefTypeList", elementJsonObject2, true);
        var scalarJsonScalar262 = new RelationalJsonScalar(refTypeListJsonArray2, false);
        refTypeListJsonArray2.ElementType = scalarJsonScalar262;
        elementJsonObject2.AddProperty(refTypeListJsonArray2);
        var valueTypeArrayJsonArray2 = new RelationalJsonArray("ValueTypeArray", elementJsonObject2, true);
        var scalarJsonScalar263 = new RelationalJsonScalar(valueTypeArrayJsonArray2, false);
        valueTypeArrayJsonArray2.ElementType = scalarJsonScalar263;
        elementJsonObject2.AddProperty(valueTypeArrayJsonArray2);
        var valueTypeEnumerableJsonArray2 = new RelationalJsonArray("ValueTypeEnumerable", elementJsonObject2, true);
        var scalarJsonScalar264 = new RelationalJsonScalar(valueTypeEnumerableJsonArray2, false);
        valueTypeEnumerableJsonArray2.ElementType = scalarJsonScalar264;
        elementJsonObject2.AddProperty(valueTypeEnumerableJsonArray2);
        var valueTypeIListJsonArray2 = new RelationalJsonArray("ValueTypeIList", elementJsonObject2, true);
        var scalarJsonScalar265 = new RelationalJsonScalar(valueTypeIListJsonArray2, false);
        valueTypeIListJsonArray2.ElementType = scalarJsonScalar265;
        elementJsonObject2.AddProperty(valueTypeIListJsonArray2);
        var valueTypeListJsonArray2 = new RelationalJsonArray("ValueTypeList", elementJsonObject2, true);
        var scalarJsonScalar266 = new RelationalJsonScalar(valueTypeListJsonArray2, false);
        valueTypeListJsonArray2.ElementType = scalarJsonScalar266;
        elementJsonObject2.AddProperty(valueTypeListJsonArray2);
        ownedColumn.JsonElement = elementJsonObject2;
        var arrayJsonArray237 = new RelationalJsonArray(refTypeArrayColumn, true);
        var scalarJsonScalar267 = new RelationalJsonScalar(arrayJsonArray237, false);
        arrayJsonArray237.ElementType = scalarJsonScalar267;
        refTypeArrayColumn.JsonElement = arrayJsonArray237;
        var arrayJsonArray238 = new RelationalJsonArray(refTypeEnumerableColumn, true);
        var scalarJsonScalar268 = new RelationalJsonScalar(arrayJsonArray238, false);
        arrayJsonArray238.ElementType = scalarJsonScalar268;
        refTypeEnumerableColumn.JsonElement = arrayJsonArray238;
        var arrayJsonArray239 = new RelationalJsonArray(refTypeIListColumn, true);
        var scalarJsonScalar269 = new RelationalJsonScalar(arrayJsonArray239, false);
        arrayJsonArray239.ElementType = scalarJsonScalar269;
        refTypeIListColumn.JsonElement = arrayJsonArray239;
        var arrayJsonArray240 = new RelationalJsonArray(refTypeListColumn, true);
        var scalarJsonScalar270 = new RelationalJsonScalar(arrayJsonArray240, false);
        arrayJsonArray240.ElementType = scalarJsonScalar270;
        refTypeListColumn.JsonElement = arrayJsonArray240;
        var arrayJsonArray241 = new RelationalJsonArray(valueTypeArrayColumn, true);
        var scalarJsonScalar271 = new RelationalJsonScalar(arrayJsonArray241, false);
        arrayJsonArray241.ElementType = scalarJsonScalar271;
        valueTypeArrayColumn.JsonElement = arrayJsonArray241;
        var arrayJsonArray242 = new RelationalJsonArray(valueTypeEnumerableColumn, true);
        var scalarJsonScalar272 = new RelationalJsonScalar(arrayJsonArray242, false);
        arrayJsonArray242.ElementType = scalarJsonScalar272;
        valueTypeEnumerableColumn.JsonElement = arrayJsonArray242;
        var arrayJsonArray243 = new RelationalJsonArray(valueTypeIListColumn, true);
        var scalarJsonScalar273 = new RelationalJsonScalar(arrayJsonArray243, false);
        arrayJsonArray243.ElementType = scalarJsonScalar273;
        valueTypeIListColumn.JsonElement = arrayJsonArray243;
        var arrayJsonArray244 = new RelationalJsonArray(valueTypeListColumn, true);
        var scalarJsonScalar274 = new RelationalJsonScalar(arrayJsonArray244, false);
        arrayJsonArray244.ElementType = scalarJsonScalar274;
        valueTypeListColumn.JsonElement = arrayJsonArray244;
        ...
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeArray")!, arrayJsonArray237, principalBaseTableMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeEnumerable")!, arrayJsonArray238, principalBaseTableMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeIList")!, arrayJsonArray239, principalBaseTableMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("RefTypeList")!, arrayJsonArray240, principalBaseTableMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeArray")!, arrayJsonArray241, principalBaseTableMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeEnumerable")!, arrayJsonArray242, principalBaseTableMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeIList")!, arrayJsonArray243, principalBaseTableMapping);
        RelationalModel.CreateJsonElementMapping(principalBase.FindProperty("ValueTypeList")!, arrayJsonArray244, principalBaseTableMapping);
        ...
        RelationalModel.CreateJsonElementMapping(principalBase.FindNavigation("Owned")!, elementJsonObject0, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase0);
        RelationalModel.CreateJsonElementMapping(ownedType.FindProperty("PrincipalBaseId")!, principalBaseIdJsonScalar, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase0);
        RelationalModel.CreateJsonElementMapping(ownedType.FindProperty("PrincipalBaseAlternateId")!, principalBaseAlternateIdJsonScalar, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase0);
        RelationalModel.CreateJsonElementMapping(ownedType.FindProperty("Details")!, detailsJsonScalar0, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase0);
        RelationalModel.CreateJsonElementMapping(ownedType.FindProperty("Number")!, numberJsonScalar0, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase0);
        RelationalModel.CreateJsonElementMapping(ownedType.FindProperty("RefTypeArray")!, refTypeArrayJsonArray0, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase0);
        RelationalModel.CreateJsonElementMapping(ownedType.FindProperty("RefTypeEnumerable")!, refTypeEnumerableJsonArray0, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase0);
        RelationalModel.CreateJsonElementMapping(ownedType.FindProperty("RefTypeIList")!, refTypeIListJsonArray0, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase0);
        RelationalModel.CreateJsonElementMapping(ownedType.FindProperty("RefTypeList")!, refTypeListJsonArray0, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase0);
        RelationalModel.CreateJsonElementMapping(ownedType.FindProperty("ValueTypeArray")!, valueTypeArrayJsonArray0, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase0);
        RelationalModel.CreateJsonElementMapping(ownedType.FindProperty("ValueTypeEnumerable")!, valueTypeEnumerableJsonArray0, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase0);
        RelationalModel.CreateJsonElementMapping(ownedType.FindProperty("ValueTypeIList")!, valueTypeIListJsonArray0, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase0);
        RelationalModel.CreateJsonElementMapping(ownedType.FindProperty("ValueTypeList")!, valueTypeListJsonArray0, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase0);
        ...
        principalBaseTable.AddRowInternalForeignKey(ownedType, RelationalModel.GetForeignKey(this,
            ...
            new[] { "Id", "AlternateId" }));
        RelationalModel.CreateJsonElementMapping(principalBase.FindNavigation("Owned")!, elementJsonObject2, principalBaseTableMapping0);
        RelationalModel.CreateJsonElementMapping(ownedType.FindProperty("PrincipalBaseId")!, principalBaseIdJsonScalar0, principalBaseTableMapping0);
        RelationalModel.CreateJsonElementMapping(ownedType.FindProperty("PrincipalBaseAlternateId")!, principalBaseAlternateIdJsonScalar0, principalBaseTableMapping0);
        RelationalModel.CreateJsonElementMapping(ownedType.FindProperty("Details")!, detailsJsonScalar2, principalBaseTableMapping0);
        RelationalModel.CreateJsonElementMapping(ownedType.FindProperty("Number")!, numberJsonScalar2, principalBaseTableMapping0);
        RelationalModel.CreateJsonElementMapping(ownedType.FindProperty("RefTypeArray")!, refTypeArrayJsonArray2, principalBaseTableMapping0);
        RelationalModel.CreateJsonElementMapping(ownedType.FindProperty("RefTypeEnumerable")!, refTypeEnumerableJsonArray2, principalBaseTableMapping0);
        RelationalModel.CreateJsonElementMapping(ownedType.FindProperty("RefTypeIList")!, refTypeIListJsonArray2, principalBaseTableMapping0);
        RelationalModel.CreateJsonElementMapping(ownedType.FindProperty("RefTypeList")!, refTypeListJsonArray2, principalBaseTableMapping0);
        RelationalModel.CreateJsonElementMapping(ownedType.FindProperty("ValueTypeArray")!, valueTypeArrayJsonArray2, principalBaseTableMapping0);
        RelationalModel.CreateJsonElementMapping(ownedType.FindProperty("ValueTypeEnumerable")!, valueTypeEnumerableJsonArray2, principalBaseTableMapping0);
        RelationalModel.CreateJsonElementMapping(ownedType.FindProperty("ValueTypeIList")!, valueTypeIListJsonArray2, principalBaseTableMapping0);
        RelationalModel.CreateJsonElementMapping(ownedType.FindProperty("ValueTypeList")!, valueTypeListJsonArray2, principalBaseTableMapping0);
        ...
        RelationalModel.CreateJsonElementMapping(principalDerived.FindNavigation("ManyOwned")!, arrayJsonArray227, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("PrincipalDerivedId")!, principalDerivedIdJsonScalar, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("PrincipalDerivedAlternateId")!, principalDerivedAlternateIdJsonScalar, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("__synthesizedOrdinal")!, __synthesizedOrdinalJsonScalar, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("Details")!, detailsJsonScalar, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("Number")!, numberJsonScalar, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("RefTypeArray")!, refTypeArrayJsonArray, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("RefTypeEnumerable")!, refTypeEnumerableJsonArray, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("RefTypeIList")!, refTypeIListJsonArray, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("RefTypeList")!, refTypeListJsonArray, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("ValueTypeArray")!, valueTypeArrayJsonArray, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("ValueTypeEnumerable")!, valueTypeEnumerableJsonArray, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("ValueTypeIList")!, valueTypeIListJsonArray, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("ValueTypeList")!, valueTypeListJsonArray, microsoftEntityFrameworkCoreScaffoldingCompiledModelTestBasePrincipalBaseMappingBase2);
        ...
        principalBaseTable.AddRowInternalForeignKey(ownedType0, RelationalModel.GetForeignKey(this,
            ...
            new[] { "Id", "AlternateId" }));
        RelationalModel.CreateJsonElementMapping(principalDerived.FindNavigation("ManyOwned")!, arrayJsonArray236, principalBaseTableMapping2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("PrincipalDerivedId")!, principalDerivedIdJsonScalar0, principalBaseTableMapping2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("PrincipalDerivedAlternateId")!, principalDerivedAlternateIdJsonScalar0, principalBaseTableMapping2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("__synthesizedOrdinal")!, __synthesizedOrdinalJsonScalar0, principalBaseTableMapping2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("Details")!, detailsJsonScalar1, principalBaseTableMapping2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("Number")!, numberJsonScalar1, principalBaseTableMapping2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("RefTypeArray")!, refTypeArrayJsonArray1, principalBaseTableMapping2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("RefTypeEnumerable")!, refTypeEnumerableJsonArray1, principalBaseTableMapping2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("RefTypeIList")!, refTypeIListJsonArray1, principalBaseTableMapping2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("RefTypeList")!, refTypeListJsonArray1, principalBaseTableMapping2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("ValueTypeArray")!, valueTypeArrayJsonArray1, principalBaseTableMapping2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("ValueTypeEnumerable")!, valueTypeEnumerableJsonArray1, principalBaseTableMapping2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("ValueTypeIList")!, valueTypeIListJsonArray1, principalBaseTableMapping2);
        RelationalModel.CreateJsonElementMapping(ownedType0.FindProperty("ValueTypeList")!, valueTypeListJsonArray1, principalBaseTableMapping2);
        ...
        var fK_DependentBasebyte_PrincipalBase_PrincipalId_PrincipalAlte = new ForeignKeyConstraint(
            "FK_DependentBase<byte?>_PrincipalBase_PrincipalId_PrincipalAlte~", dependentBasebyteTable, principalBaseTable,
            new[] { principalIdColumn, principalAlternateIdColumn },
            principalBaseTable.FindUniqueConstraint("PK")!, ReferentialAction.NoAction);
        fK_DependentBasebyte_PrincipalBase_PrincipalId_PrincipalAlte.SetRowForeignKeyValueFactory(new CompositeRowForeignKeyValueFactory(fK_DependentBasebyte_PrincipalBase_PrincipalId_PrincipalAlte));
        var fK_DependentBasebyte_PrincipalBase_PrincipalId_PrincipalAlteFk = RelationalModel.GetForeignKey(this,
            "Microsoft.EntityFrameworkCore.Scaffolding.CompiledModelTestBase+DependentBase<byte?>",
            new[] { "PrincipalId", "PrincipalAlternateId" },
            "Microsoft.EntityFrameworkCore.Scaffolding.CompiledModelTestBase+PrincipalDerived<Microsoft.EntityFrameworkCore.Scaffolding.CompiledModelTestBase+DependentBase<byte?>>",
            new[] { "Id", "AlternateId" });
        fK_DependentBasebyte_PrincipalBase_PrincipalId_PrincipalAlte.MappedForeignKeys.Add(fK_DependentBasebyte_PrincipalBase_PrincipalId_PrincipalAlteFk);
        RelationalModel.GetOrCreateForeignKeyConstraints(fK_DependentBasebyte_PrincipalBase_PrincipalId_PrincipalAlteFk).Add(fK_DependentBasebyte_PrincipalBase_PrincipalId_PrincipalAlte);
        dependentBasebyteTable.ForeignKeyConstraints.Add(fK_DependentBasebyte_PrincipalBase_PrincipalId_PrincipalAlte);
        principalBaseTable.ReferencingForeignKeyConstraints.Add(fK_DependentBasebyte_PrincipalBase_PrincipalId_PrincipalAlte);
        var fK_PrincipalBasePrincipalDerivedDependentBasebyte_Principa = new ForeignKeyConstraint(
            "FK_PrincipalBasePrincipalDerived<DependentBase<byte?>>_Principa~", principalBasePrincipalDerivedDependentBasebyteTable, principalBaseTable,
        ...
        principalBaseTable.ReferencingForeignKeyConstraints.Add(fK_PrincipalBasePrincipalDerivedDependentBasebyte_Principa);
