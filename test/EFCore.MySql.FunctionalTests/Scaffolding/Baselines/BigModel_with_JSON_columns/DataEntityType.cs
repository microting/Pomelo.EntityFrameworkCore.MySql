    ...
    public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
    {
        ...
        stringWithCharSet.TypeMapping = MySqlStringTypeMapping.Default.Clone(
            ...
            mappingInfo: new RelationalTypeMappingInfo(
                ...
                size: 128),
            converter: new ValueConverter<string, string>(string (string v) => ((string)v), string (string v) => ((string)v)),
            jsonValueReaderWriter: new JsonConvertedValueReaderWriter<string, string>(
                JsonStringReaderWriter.Instance,
                new ValueConverter<string, string>(string (string v) => ((string)v), string (string v) => ((string)v))));
