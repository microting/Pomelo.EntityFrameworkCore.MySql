    ...
    public partial class DataEntityType
    {
        public static RuntimeEntityType Create(RuntimeModel model, RuntimeEntityType baseEntityType = null)
        {
            ...
            var point = runtimeEntityType.AddProperty(
                ...
                nullable: true);
            point.SetAccessors(
                Point (IInternalEntry entry) => (entry.FlaggedAsStoreGenerated(2) ? entry.ReadStoreGeneratedValue<Point>(1) : entry.ReadShadowValue<Point>(1)),
            ...
            point.SetPropertyIndexes(
                ...
                relationshipIndex: -1,
                storeGenerationIndex: 1);
            point.TypeMapping = MySqlGeometryTypeMapping<Point>.Default.Clone(
                comparer: new ValueComparer<Point>(
                    bool (Point v1, Point v2) => object.Equals(((object)(v1)), ((object)(v2))),
                    int (Point v) => ((object)v).GetHashCode(),
                    Point (Point v) => v),
                keyComparer: new ValueComparer<Point>(
                    bool (Point v1, Point v2) => object.Equals(((object)(v1)), ((object)(v2))),
                    int (Point v) => ((object)v).GetHashCode(),
                    Point (Point v) => v),
                providerValueComparer: new ValueComparer<Point>(
                    bool (Point v1, Point v2) => object.Equals(((object)(v1)), ((object)(v2))),
                    int (Point v) => ((object)v).GetHashCode(),
                    Point (Point v) => v));
            ...
            stringWithCharSet.SetAccessors(
                string (IInternalEntry entry) => (entry.FlaggedAsStoreGenerated(3) ? entry.ReadStoreGeneratedValue<string>(2) : entry.ReadShadowValue<string>(2)),
            ...
            stringWithCharSet.TypeMapping = MySqlStringTypeMapping.Default.Clone(
                comparer: new CompiledModelTestBase.CustomValueComparer<string>(),
                keyComparer: new CompiledModelTestBase.CustomValueComparer<string>(),
                providerValueComparer: new CompiledModelTestBase.CustomValueComparer<string>(),
            ...
            stringWithCollation.SetAccessors(
                string (IInternalEntry entry) => (entry.FlaggedAsStoreGenerated(4) ? entry.ReadStoreGeneratedValue<string>(3) : entry.ReadShadowValue<string>(3)),
        ...
        public static void CreateAnnotations(RuntimeEntityType runtimeEntityType)
        {
            ...
            runtimeEntityType.SetStoreGeneratedValuesFactory(
                ISnapshot () => ((ISnapshot)(new Snapshot<int, Point, string, string>(((ValueComparer<int>)(((IProperty)id).GetValueComparer())).Snapshot(default(int)), default(Point), default(string), default(string)))));
