...
using Microting.EntityFrameworkCore.MySql.Json.Newtonsoft.Storage.ValueComparison.Internal;
...
namespace Microting.EntityFrameworkCore.MySql.Json.Newtonsoft.Extensions.Internal
{
    /// <summary>
    ...
    /// </summary>
    public static class MySqlInternalJsonNewtonsoftPropertyExtensions
    {
        /// <summary>
        ///     This is an internal API that supports the Entity Framework Core infrastructure and not subject to
        ///     the same compatibility standards as public APIs. It may be changed or removed without notice in
        ...
        public static void SetJsonChangeTrackingOptions([NotNull] this IMutableProperty property, MySqlJsonChangeTrackingOptions? options)
        {
            ...
            property.SetValueComparer(
                valueComparer is IMySqlJsonValueComparer mySqlJsonValueComparer
                    ...
                    : MySqlJsonNewtonsoftValueComparer.Create(property.ClrType, options.Value));
        }
    }
}
