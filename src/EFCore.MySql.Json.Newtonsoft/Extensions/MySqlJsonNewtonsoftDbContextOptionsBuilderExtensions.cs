...
namespace Microsoft.EntityFrameworkCore
{
    ...
    /// </summary>
    public static class MySqlJsonNewtonsoftDbContextOptionsBuilderExtensions
    {
        /// <summary>
            ...
            MySqlCommonJsonChangeTrackingOptions options = MySqlCommonJsonChangeTrackingOptions.RootPropertyOnly)
        {
            ...
            var extension = (coreOptionsBuilder.Options.FindExtension<MySqlJsonNewtonsoftOptionsExtension>() ??
