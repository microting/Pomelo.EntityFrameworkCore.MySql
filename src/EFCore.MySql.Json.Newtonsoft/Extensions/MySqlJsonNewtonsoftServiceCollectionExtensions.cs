...
using Microting.EntityFrameworkCore.MySql.Json.Newtonsoft.Query.Internal;
...
{
    /// <summary>
    ///     Microting.EntityFrameworkCore.MySql.Json.Newtonsoft extension methods for <see cref="IServiceCollection" />.
    /// </summary>
    public static class MySqlJsonNewtonsoftServiceCollectionExtensions
    {
        /// <summary>
        ///     Adds the services required for JSON.NET support (Newtonsoft.Json) in Microting's MySQL provider for Entity Framework Core.
        /// </summary>
